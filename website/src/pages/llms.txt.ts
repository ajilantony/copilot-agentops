...
const GITHUB_RAW_BASE = "https://raw.githubusercontent.com/github/copilot-agentops/main";
...
export const GET: APIRoute = () => {
  ...
  content += "## Repository\n\n";
  content += "- **GitHub**: https://github.com/github/copilot-agentops\n";
  content += "- **License**: MIT\n";
  content += "- **Website**: https://github.github.io/copilot-agentops\n";
