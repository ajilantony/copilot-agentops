/**
 * Utility functions for the Copilot AgentOps website
 */

const REPO_BASE_URL =
  "https://raw.githubusercontent.com/github/copilot-agentops/main";
const REPO_GITHUB_URL = "https://github.com/github/copilot-agentops/blob/main";
...
> = {
  instructions: {
    baseUrl: "https://aka.ms/copilot-agentops/install/instructions",
    scheme: "chat-instructions",
  },
  prompt: {
    baseUrl: "https://aka.ms/copilot-agentops/install/prompt",
    scheme: "chat-prompt",
  },
  agent: {
    baseUrl: "https://aka.ms/copilot-agentops/install/agent",
    scheme: "chat-agent",
  },
};
