...
const AKA_INSTALL_URLS = {
  instructions: "https://aka.ms/copilot-agentops/install/instructions",
  prompt: "https://aka.ms/copilot-agentops/install/prompt",
  agent: "https://aka.ms/copilot-agentops/install/agent",
  hook: "https://aka.ms/copilot-agentops/install/hook",
};
