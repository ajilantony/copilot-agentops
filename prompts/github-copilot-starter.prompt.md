...
**Chat Mode Attribution**: When using content from copilot-agentops chatmodes, add attribution comments:
```markdown
<!-- Based on/Inspired by: https://github.com/github/copilot-agentops/blob/main/agents/[filename].agent.md -->
```
...
1. **Fetch from copilot-agentops collections**: https://github.com/github/copilot-agentops/blob/main/docs/README.collections.md
2. **Fetch specific instruction files**: https://raw.githubusercontent.com/github/copilot-agentops/main/instructions/[relevant-file].instructions.md
3. **Check for existing patterns** that match the technology stack

**Primary Approach**: Reference and adapt existing instructions from copilot-agentops repository:
...
- **ALWAYS add attribution comments** when using copilot-agentops content

**Attribution Format**: When using content from copilot-agentops, add this comment at the top of the file:
```markdown
<!-- Based on/Inspired by: https://github.com/github/copilot-agentops/blob/main/instructions/[filename].instructions.md -->
```

**Examples:**
```markdown
<!-- Based on: https://github.com/github/copilot-agentops/blob/main/instructions/react.instructions.md -->
---
applyTo: "**/*.jsx,**/*.tsx"
...
```markdown
<!-- Inspired by: https://github.com/github/copilot-agentops/blob/main/instructions/java.instructions.md -->
<!-- and: https://github.com/github/copilot-agentops/blob/main/instructions/spring-boot.instructions.md -->
---
applyTo: "**/*.java"
...
**Secondary Approach**: If no copilot-agentops instructions exist, create **SIMPLE GUIDELINES ONLY**:
...
1. **Check copilot-agentops first** - Always start here for ALL file types
...
4. **Check copilot-agentops collections** for curated sets of related files
5. **Adapt community examples** to project needs
6. **Only create custom content** if nothing relevant exists

**Fetch these copilot-agentops directories:**
- **Instructions**: https://github.com/github/copilot-agentops/tree/main/instructions
- **Prompts**: https://github.com/github/copilot-agentops/tree/main/prompts  
- **Chat Modes**: https://github.com/github/copilot-agentops/tree/main/chatmodes
- **Collections**: https://github.com/github/copilot-agentops/blob/main/docs/README.collections.md

**copilot-agentops Collections to Check:**
...
4. **Create language-specific instruction files using copilot-agentops references**
