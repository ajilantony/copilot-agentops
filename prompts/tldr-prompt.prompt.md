...
considered **Ambiguous Queries**
  - If the user provides raw text without a **specific file** or **URL**, identify the topic:
    * Prompts, agents, instructions, collections → Search workspace first
      - If no relevant files found, check https://github.com/github/copilot-agentops and resolve to
      https://raw.githubusercontent.com/github/copilot-agentops/refs/heads/main/{{folder}}/{{filename}}
      (e.g., https://raw.githubusercontent.com/github/copilot-agentops/refs/heads/main/prompts/java-junit.prompt.md)
...
1. **Identify topic category**:
   ...
   .collections.md
     ...
     `prompts` folders is irrelevant to query → Search https://github.com/github/copilot-agentops
...
2. **Search strategy**:
   ...
   - For GitHub copilot-agentops: Fetch raw content from https://raw.githubusercontent.com/github/copilot-agentops/refs/heads/main/
   - For documentation: Use fetch tool with the most relevant URL from above

3. **Fetch content**:
   - Workspace files: Read using file tools
   - GitHub copilot-agentops files: Fetch using raw.githubusercontent.com URLs
...
> resolve using GitHub copilot-agentops as specified in **URL Resolver** section.
...
```text
I'll check https://github.com/github/copilot-agentops
Found:
- https://github.com/github/copilot-agentops/blob/main/prompts/java-docs.prompt.md
- https://github.com/github/copilot-agentops/blob/main/prompts/java-junit.prompt.md

Now let me fetch the raw content:
- https://raw.githubusercontent.com/github/copilot-agentops/refs/heads/main/prompts/java-docs.prompt.md
- https://raw.githubusercontent.com/github/copilot-agentops/refs/heads/main/prompts/java-junit.prompt.md
