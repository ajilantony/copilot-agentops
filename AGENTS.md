...
The Copilot AgentOps repository is a community-driven collection of custom agents, prompts, and instructions designed to enhance GitHub Copilot experiences across various domains, languages, and use cases. The project includes:
...
6. Test plugin installation: `copilot plugin install <plugin-name>@copilot-agentops`
